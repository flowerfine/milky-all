package cn.sliew.milky.remote.buffer;
 ...
 * <p/>
 * It is recommended to create a new buffer using the helper methods in {ChannelBuffers} rather than calling an individual implementation's
 * constructor.
 * <p/>
