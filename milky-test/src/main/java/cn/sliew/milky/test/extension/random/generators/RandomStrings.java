...
public final class RandomStrings {
    ...
    public static String randomAsciiLettersOfLengthBetween(Random r, int minCodeUnits, int maxCodeUnits) {
    ...
    public static String randomAsciiAlphanumOfLengthBetween(Random r, int minCodeUnits, int maxCodeUnits) {
    ...
    public static String randomUnicodeOfCodepointLengthBetween(Random r, int minCodePoints, int maxCodePoints) {
    ...
    public static String randomRealisticUnicodeOfLengthBetween(Random r, int minCodeUnits, int maxCodeUnits) {
    ...
    public static String randomRealisticUnicodeOfCodepointLengthBetween(Random r, int minCodePoints, int maxCodePoints) {
